...
<html data-wf-page="650071e17cd3c26438526047" data-wf-site="64e5ed3359b16400aec286b0">
<head>
  <meta charset="utf-8">
  <title>model</title>
  ...
  <meta content="model" property="twitter:title">
...
<body class="body-5">
  ...
  <div class="page-wra784y">
            ...
            <nav role="navigation" class="nav-menu w-nav-menu">
              ...
              <div data-hover="false" data-delay="0" class="dropdown w-dropdown">
                ...
                <nav class="w-dropdown-list">
                  ...
                  <a href="account-details/viewpurchasehistory.html" aria-current="page" class="dropdown-link-5 w-dropdown-link w--current">檢視購買記錄</a>
                </nav>
              </div>
    ...
    <div class="section-c15615y-copy haze-c156py-copy-copy no-padding-to156py-copy-copy">
      <div class="w-layout-blockcontainer w-container">
        <div class="div-block-11-copy-copy-copy">
          <h6 class="heading-4">
            <a href="index.html" class="link-5">首頁</a>&gt;<a href="#" class="link-4">會員中心</a>&gt;<a href="#" class="link-3">購買紀錄</a>
          </h6>
          <div class="div-block-10">
            <h3 class="heading-15">Tere880 的購買紀錄</h3>
            <div class="w-layout-blockcontainer container-8 w-container">
              <div class="div-block-6">
                <h6 class="heading-6">日期</h6>
                <div id="w-node-_9918e391-f400-77f8-6d15-7de42ad3aed8-38526047">2021/06/25</div>
                <div id="w-node-_4415dbb6-3a6c-1e7b-0f70-3965e20b112b-38526047">2021/06/25</div>
                <div id="w-node-b06d2de8-5238-ef30-349a-0f3fbb4c3b1a-38526047">2021/06/25</div>
              </div>
              <div class="div-block-7">
                <h6 class="heading-7">物品</h6>
                <div id="w-node-_7d094d73-3116-19db-8316-66b1a1d46001-38526047">This is some text inside of a div block.</div>
                <div id="w-node-fe29563a-1fa4-6dd4-edd1-e93357cfebf0-38526047">This is some text inside of a div block.</div>
                <div id="w-node-_21eb060b-e59e-9db4-3169-dfff5c68ae30-38526047">This is some text inside of a div block.</div>
              </div>
              <div class="div-block-8">
                <h6 class="heading-8">類型</h6>
                <div id="w-node-c5cb7651-ff6b-23e9-6aa5-d69cbe0d5b47-38526047">
                  <div class="text-block-27">style of the game</div>
                </div>
                <div id="w-node-af66083a-18f2-ecd1-7c18-b88a7b1a476f-38526047" class="text-block-28">style of the game</div>
                <div id="w-node-d6fe2060-7a5d-d8ef-fc18-eb29205d0ae5-38526047" class="text-block-29">style of the game</div>
              </div>
              <div class="div-block-8">
                <h6 class="heading-8">總計</h6>
                <div id="w-node-_583a994e-5bac-583d-219b-6e8d0ab57037-38526047">
                  <div class="text-block-30">$1,200</div>
                </div>
                <div class="text-block-5">$1,200</div>
                <div class="text-block-31">$1,200</div>
              </div>
            </div>
          </div>
        </div>
  ...
  <section class="footer-light-0185y">
    <div class="container">
      <div class="footer-wrapper-two">
        ...
        <div class="footer-form w-form">
          <form id="wf-form-Footer-Form" name="wf-form-Footer-Form" data-name="Footer Form" method="get" class="footer-form-container" data-wf-page-id="650071e17cd3c26438526047" data-wf-element-id="46578c48-6a9f-dcb7-354b-93a43f0c07b8">
