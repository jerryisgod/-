...
<html data-wf-page="650071e17cd3c26438526009" data-wf-site="64e5ed3359b16400aec286b0">
<head>
  <meta charset="utf-8">
  <title>topUp</title>
  ...
  <meta content="topUp" property="og:title">
  ...
  <meta content="topUp" property="twitter:title">
...
<body>
  ...
  <div class="page-wrapper">
        ...
        <div class="wrapper nav-bar-wrapper">
          ...
          <div class="navigation">
            <nav role="navigation" class="nav-menu w-nav-menu">
              ...
              <a href="topup.html" aria-current="page" class="nav-link w-nav-link w--current">點數商店</a>
    ...
    <div class="s1tion489-155py no-padding-vertical-copy">
      <div class="wrapper side-paddings"></div>
    </div>
    <div class="wrapper"></div>
    <section class="team-circles">
      <div class="container-10-copy">
        <h5 class="heading-3-1859opy">
          <a href="#" class="link-6">首頁</a>&gt;點數商店
        </h5>
        <h2 class="centered-heading-2-copy">儲值5team點數</h2>
        <div class="team-grid">
          <div id="w-node-_2e76f9aa-ea3b-ae1c-67d7-64cddf4701df-38526009" class="team-card"><img src="images/372394085_1427655987777278_6198865964171164924_n-removebg-preview-2.png" loading="lazy" alt="" class="team-member-image">
            <div class="team-member-name">5team點數100點</div>
            <a href="http://localhost:8081/ecpayCheckoutPoints?points=100" class="button-84 w-button" onclick="buyPoints(100);">購買</a>
          </div>
          <div id="w-node-_2e76f9aa-ea3b-ae1c-67d7-64cddf4701ea-38526009" class="team-card"><img src="images/372855080_293725733353540_2252901647883920232_n-removebg-preview.png" loading="lazy" alt="" class="team-member-image">
            <div class="team-member-name">5team點數500點</div>
            <a href="http://localhost:8081/ecpayCheckoutPoints?points=500" class="button-85 w-button" onclick="buyPoints(500);">購買</a>
          </div>
          <div id="w-node-_2e76f9aa-ea3b-ae1c-67d7-64cddf4701f4-38526009" class="team-card"><img src="images/372333336_1027060561782114_5310769359458361987_n-removebg-preview.png" loading="lazy" alt="" class="team-member-image">
            <div class="team-member-name">5team點數1000點</div>
            <a href="http://localhost:8081/ecpayCheckoutPoints?points=1000" class="button-86 w-button" onclick="buyPoints(1000);">購買</a>
          </div>
          <div id="w-node-_2e76f9aa-ea3b-ae1c-67d7-64cddf4701fe-38526009" class="team-card"><img src="images/372380165_257646803847719_9048534664816840139_n-removebg-preview.png" loading="lazy" alt="" class="team-member-image">
            <div class="team-member-name">5team點數2000點</div>
            <a href="http://localhost:8081/ecpayCheckoutPoints?points=2000" class="button-87 w-button" onclick="buyPoints(2000);">購買</a>
          </div>
          <div id="w-node-_2e76f9aa-ea3b-ae1c-67d7-64cddf470208-38526009"  class="team-card"><img src="images/372834774_1019831482769988_5981102235570561067_n-removebg-preview.png" loading="lazy" alt="" class="team-member-image">
            <div class="team-member-name">5team點數5000點</div>
            <a href="http://localhost:8081/ecpayCheckoutPoints?points=5000" class="button-88 w-button" onclick="buyPoints(5000);">購買</a>
          </div>
          <div id="w-node-_2e76f9aa-ea3b-ae1c-67d7-64cddf470212-38526009" class="team-card"><img src="images/373072421_318535720674271_5740573417106735184_n-removebg-preview.png" loading="lazy" alt="" class="team-member-image">
            <div class="team-member-name">5team點數10000點</div>
            <a href="http://localhost:8081/ecpayCheckoutPoints?points=10000" class="button-89 w-button" onclick="buyPoints(10000);">購買</a>
          </div>
        </div>
      </div>
    </section>
    ...
    <div id="More-About" class="section">
      <div class="wrapper">
        <div class="side-blocks mobile-reverse">
          <div class="side-block small-padding-side"></div>
        </div>
      </div>
    </div>
    <section class="fo152191825y-copy">
      <div class="container">
        <div class="footer-wrapper-two">
          ...
          <div class="footer-form w-form">
            <form id="wf-form-Footer-Form" name="wf-form-Footer-Form" data-name="Footer Form" method="get" class="footer-form-container" data-wf-page-id="650071e17cd3c26438526009" data-wf-element-id="7cbe9da6-3789-9dfe-6098-76e10e14e779">
      ...
      <div class="footer-bottom-2">
        ...
        <a href="#" class="footer-social-link-2 w-inline-block"><img src="images/face-removebg-preview.png" loading="lazy" width="96" alt="" class="image-43"></a>
        <a href="#" class="footer-social-link-2 w-inline-block"><img src="images/Twi-removebg-preview.png" loading="lazy" width="97" alt="" class="image-42"></a>
...
function buyPoints(points) {
	  const userId = 8;  // 使用者ID

	  fetch('/pointpaysucces', {
	    method: 'POST',
	    headers: {
