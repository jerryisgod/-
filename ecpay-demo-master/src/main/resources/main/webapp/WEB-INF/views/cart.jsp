...
<html data-wf-page="6500730b1d81c0f2b1ba0647"
	...
	<div class="page999opy">
				...
				<div class="wrapper nav-bar-wrapper">
					...
					<div class="navigation">
						<nav role="navigation" class="nav-menu w-nav-menu">
							<a href="http://localhost:8080/" class="nav-link w-nav-link">首頁</a>
		...
		<section class="pricing-items">
			<div class="w-layout-blockcontainer container-34 w-container">
							...
							<div class="pricing-card-two">
								...
								<div class="pricing-content">
									<div class="pricing-info">
										<h3>
											<strong>商品名稱:${cart.itemId}</strong>
										</h3>
										<h4>價格${cart.price}$</h4>
										<form action="/deleteCartItem" method="post">
											<input type="hidden" name="cartItemId"
												value="${cart.cartId}">
											<button type="submit"
												style="background-color: #ff0000; color: #ffffff; padding: 5px 10px; border: none; border-radius: 5px; cursor: pointer; font-size: 14px;">删除</button>
										</form>
									</div>
								</div>
							</div>
				...
				<div class="pricing111">
					<div class="prici88opy">
						<div class="pricing-info-77">
							<h3>總價</h3>
							<h3>${totalPrice}</h3>
...
<a href="http://10.0.101.72:8080/order" class="button-90 w-button">購買</a>
				</div>
			</div>
	</div>
		...
		<div class="prici88opy">
			<div class="pricing-info-77">
				<c:forEach var="balance" items="${accountBalances}">
					<!-- 顯示點數餘額 -->
					<h3>目前點數</h3>
					<h3>${balance.currentAccountBalance}$</h3>
				</c:forEach>
			</div>
		</div>
		<a href="http://10.0.101.72:8080/order" class="button-90 w-button">購買</a>
	...
	<section class="fo733opy">
			...
			<div class="footer-wrapper-two">
				...
				<div class="footer-form w-form">
					<form id="wf-form-Footer-Form" name="wf-form-Footer-Form"
						data-name="Footer Form" method="get" class="footer-form-container"
						data-wf-page-id="6500730b1d81c0f2b1ba0647"
						data-wf-element-id="c4bd483b-2037-1d4e-3dd3-6bef3b460033">
						<div class="footer-title">Subscribe</div>
						<div class="footer-form-block">
							<input type="email" class="footer-form-field w-input"
								maxlength="256" name="Footer-Email-2" data-name="Footer Email 2"
								aria-label="Get product updates"
								placeholder="Get product updates" id="Footer-Email-2"
		...
		<div class="footer-bottom-2">
			<div class="footer-copyright">© 2023 5team. All rights reserved
			</div>
